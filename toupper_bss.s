...
.lcomm BSS_FD_IN,           WORD_SIZE
.lcomm BSS_FD_OUT,          WORD_SIZE
...
_start:
  ...
  store_fd_in:
    movq %rax,            BSS_FD_IN # save FD_IT to stack
  ...
  store_fd_out:
    movq %rax,                  BSS_FD_OUT # save FD_OUT to stack
  ...
  read_loop_begin:
    ...
    movq BSS_FD_IN,             %rdi  # move FD_IN to %rbx
  ...
  continue_read_loop:
    ...
    movq BSS_FD_OUT,       %rdi # move name of the file
